...
const About = () => {
  return (
    <div id="about" className="w-full md:h-screen p-4 flex items-center py-10">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        ...
        <div className="w-full h-auto m-auto rounded-xl flex items-center justify-center p-5 hover:scale-105 ease-in duration-300">
